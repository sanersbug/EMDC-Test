...
if __name__ == "__main__":
    ...
    parser.add_argument("--arch", default='EMDC', help="Decide the model structure")
    parser.add_argument("--txt_path", default='./data/validation_input/modified_phone_static/data.list', help="The path of test.txt.")
    parser.add_argument("--out_path", default='', help="The path of out.txt.")
    parser.add_argument("--readme_path", default='', help="The path of readme.txt.")
    parser.add_argument("--ckp_path", default='./checkpoints/milestone.pth.tar', help="The path of ckp file.")
    parser.add_argument("--gpu", default='0', type=str, help="Select single GPU idx.")
    parser.add_argument("--visualization", default=1, type=int, help="use lsgan")
    parser.add_argument("--seemap", default=0, type=int, help="see map")
    parser.add_argument("--output_num", default=3, type=int, help="num of outputs")
